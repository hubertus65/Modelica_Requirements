...
package Interfaces "Library of interfaces and of partial blocks"
  ...
  connector PropertyInput =   input Requirements.Types.Property
...
<p>
Connector with one input signal of type Requirements.Types.Property.
</p>
</html>"));

  connector PropertyOutput = output Requirements.Types.Property
    ...
    Documentation(info="<html>
<p>
Connector with one output signal of type Requirements.Types.Property.
</p>
</html>"));

  connector PropertyVectorInput =input Requirements.Types.Property
...
for example <a href=\"modelica://Requirements.Interfaces.PartialPropertyVISO\">PartialPropertyVISO</a>,
...
<p>This icon indicates Modelica functions.</p>
  ...
  partial block PartialPropertyVISO
    ...
    parameter Integer nu(min=0) = 0 "Number of input connections"
      annotation (Dialog(connectorSizing=true), HideResult=true);
    Requirements.Interfaces.PropertyVectorInput u[nu]
      "Vector of Boolean input signals"
      annotation (Placement(transformation(extent={{-60,40},{-40,-40}})));
...
If this is not desired, drag Requirements.Interfaces.ObservationID
into the top level of your model.");
  ...
  partial block PartialRequirement
    ...
    input Requirements.Types.Property localProperty
      "Property that is required to be satisfied";

  protected
    outer Requirements.Verify.PrintViolations printViolations;
    outer Requirements.Interfaces.ObservationID observationID;
 ...
 */
  ...
  */
    model Dummy
      ...
      Requirements.Internal.SortingPort sortingPort;
    equation
      sortingPort.one = one;
  ...
  */
  ...
  algorithm
    when time < evaluationTime and change(localProperty) then // first condition was not terminal()
  ...
  equation
    ...
    when time >= evaluationTime then // condition was terminal()
      ok =Requirements.Internal.printViolationsToLogFile(
...
<a href=\"modelica://Requirements.LogicalBlocks.ToProperty\">ToProperty</a>,
<a href=\"modelica://Requirements.LogicalBlocks.During\">During</a>, or
<a href=\"modelica://Requirements.Temporal.WhenRising\">WhenRising</a>
</p>
...
<a href=\"modelica://Requirements.Examples.Textual.Elementary.Verify.Requirement\">Examples.Textual.Elementary.Verify.Requirement</a>.
</p>
</html>"));
  ...
  protected
    inner Requirements.Interfaces.ObservationID observationID(name=observationName);
