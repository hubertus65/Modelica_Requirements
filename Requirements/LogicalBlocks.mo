...
package LogicalBlocks
  ...
  block BooleanToProperty
    ...
    Requirements.Interfaces.PropertyOutput y "Property output signal"
...
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.Conversions\">Conversions</a>.
</p>
</html>"));
...
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.Conversions\">Conversions</a>.
  ...
  block PropertyToBoolean
    ...
    Requirements.Interfaces.PropertyInput u "Property input signal"
...
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.Conversions\">Conversions</a>.
  ...
  block GreaterThreshold
    "Output y is true if input u is greater than threshold"
     extends Requirements.Interfaces.partialThresholdComparison;
  equation
    y = u > threshold;
...
<p>
This block is demonstrated with example
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.ThresholdComparisons\">ThresholdComparisons</a>.
</p>
</html>"));
...
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.DelayedRising\">example</a>: 
</p>
...
<tr><td></td>
  ...
  block AnyTrue
    ...
    extends Requirements.Interfaces.PartialBooleanVISO;

  equation
    y = Requirements.LogicalFunctions.exists(u);
...
<p>
This block is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks\">example</a>: 
</p>
...
This block is similar to block <a href=\"modelica://Modelica.Blocks.MathBoolean.Or\">Or</a>, but has a slightly different icon and the internal function call is inlined (so it is a bit more efficient).
  ...
  equation
    y = Requirements.LogicalFunctions.forall(u);
...
<p>
This block is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.AllTrue\">example</a>: 
</p>
...
This block is similar to block <a href=\"modelica://Modelica.Blocks.MathBoolean.And\">And</a>, but has a slightly different icon, the internal function call is inlined (so it is a bit more efficient), and y = true instead of false, if there are no connections.
  ...
  block PropertyNot "3-valued logic 'not' of Property input u: y = not u"
    ...
    Requirements.Interfaces.PropertyInput u "Property input signal" annotation (Placement(transformation(extent={{-90,-20},{-50,20}})));
...
<p>
This block is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.PropertyNot\">example</a>: 
</p>
...
<tr><td></td>
  ...
  block PropertyOr
    ...
    extends Requirements.Interfaces.PartialPropertyVISO;
...
<p>
This block is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.PropertyOr\">example</a>: 
</p>
...
<p>
This block is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.LogicalBlocks.PropertyAnd\">example</a>: 
</p>
