...
model LimitedControlFrequency
  ...
  Requirements.SignalAnalysis.CrossingMonitoring crossing(threshold=
        0.4) annotation (Placement(transformation(extent={{-4,60},{16,80}})));
  Requirements.ChecksInSlidingWindow.MaxFrequency meanFreq(
    check=crossing.y,
    window=2,
    freqHzMeanMax=1.5)
    annotation (Placement(transformation(extent={{-52,10},{-12,30}})));
  Requirements.Sources.RealExpression expr1(y=2*exp(-0.2*
        time)*sin(2*pi*(0.15*time)*time))
    annotation (Placement(transformation(extent={{-80,60},{-18,80}})));
  Requirements.Verify.BooleanRequirement requirement(text="The frequency of the control signal
...
<a href=\"modelica://Requirements.ChecksInSlidingWindow.MeanFrequency\">ChecksInSlidingWindow.MeanFrequency</a>
block. 
</p>
...
<p><blockquote>
<img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/LimitedControlFrequency1.png\">
</blockquote></p>
...
<tr><td width=\"50\"></td>
    <td valign=\"bottom\"><img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/LimitedControlFrequency2.png\"></td>
    </tr>
