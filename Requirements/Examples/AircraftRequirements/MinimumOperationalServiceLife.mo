...
model MinimumOperationalServiceLife
  ...
  inner Requirements.Verify.PrintViolations printViolations(evaluationTime = 99999)
    annotation (Placement(transformation(extent={{-84,-6},{-64,14}})));
  Requirements.Verify.Requirement R_OpLife(text="The aircraft shall be designed for an
...
whichever is more stringent.")
  ...
  Requirements.ChecksInFixedWindow.MinDuration minDuration1(check=
        InFlight.y, durationMin(displayUnit="h") = 2880000)
    annotation (Placement(transformation(extent={{-46,-6},{-6,14}})));
  Requirements.ChecksInFixedWindow.MinRising minRising1(check=
  ...
  Requirements.LogicalBlocks.PropertyAnd and1(nu=2)
...
<a href=\"modelica://Requirements.ChecksInFixedWindow.MinDuration\">ChecksInFixedWindow.MinDuration</a>
and <a href=\"modelica://Requirements.ChecksInFixedWindow.MinRising\">ChecksInFixedWindow.MinRising</a> blocks 
and an <a href=\"modelica://Requirements.LogicalBlocks.PropertyAnd\">and</a> block for 3-valued logic.
</p>
...
<p><blockquote>
<img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/MinimumOperationalServiceLife1.png\">
</blockquote></p>
...
<tr><td width=\"50\"></td>
    <td valign=\"bottom\"><img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/MinimumOperationalServiceLife2.png\"></td>
    </tr>
