...
model MinimumAirDistributionPerformance
  ...
  Requirements.Verify.Requirement Requirement_AirCircuitOneEngine(text="In flight, with only one engine 
...
shall provide nominal performances.")
  ...
  Requirements.ChecksInFixedWindow.During during1(check=
...
<a href=\"modelica://Requirements.ChecksInFixedWindow.During\">ChecksInFixedWindow.During</a>
block.
</p>
...
<p><blockquote>
<img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/MinimumAirDistributionPerformance1.png\">
</blockquote></p>
...
<tr><td width=\"50\"></td>
    <td valign=\"bottom\"><img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/MinimumAirDistributionPerformance2.png\"></td>
    </tr>
