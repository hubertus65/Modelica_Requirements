...
model PreventHeatExchangerClogging
  ...
  Requirements.Verify.BooleanRequirement R_Clogging(text="To prevent clogging of the cold heat
...
is limited by %Mmax kg.")
  ...
  Requirements.LogicalBlocks.LessThreshold less(threshold=
...
<a href=\"modelica://Requirements.SignalAnalysis.TriggeredIntegrator\">SignalAnalysis.TriggeredIntegrator</a> 
and <a href=\"modelica://Requirements.LogicalBlocks.LessThreshold\">LogicalBlocks.LessThreshold</a> 
blocks.
</p>
...
<p><blockquote>
<img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/PreventHeatExchangerClogging1.png\">
</blockquote></p>
...
<tr><td width=\"50\"></td>
    <td valign=\"bottom\"><img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/PreventHeatExchangerClogging2.png\"></td>
    </tr>
