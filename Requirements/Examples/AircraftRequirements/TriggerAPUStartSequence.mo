...
model TriggerAPUStartSequence
  ...
  Requirements.Verify.Requirement R_APUTriggering(text="APU (Auxiliar Power Unit) start 
sequence shall start after three 
succesive start failures of one 
of the engines.")
    annotation (Placement(transformation(extent={{26,26},{86,46}})));
  Requirements.ChecksInFixedWindow.MaxRising maxRising1(
...
<a href=\"modelica://Requirements.ChecksInFixedWindow.MaxRising\">ChecksInSlidingWindow.MaxRising</a>
block. 
</p>
...
<p><blockquote>
<img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/TriggerAPUStartSequence1.png\">
</blockquote></p>
...
<tr><td width=\"50\"></td>
    <td valign=\"bottom\"><img src=\"modelica://Requirements/Resources/Images/Examples/AircraftRequirements/TriggerAPUStartSequence2.png\"></td>
    </tr>
