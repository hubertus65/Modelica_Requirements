...
package MotorsWithLosses
  ...
  model CheckMotorWithLosses
    ...
    annotation (experiment(StopTime=2),Documentation(info = "<html><p>Same (stupid) issue as with pump system: passing classes instad of records. doh!</p></html>"),Icon(graphics = {Ellipse(origin={104,48},extent={{-66.7957211492899,63.09564305521677},{66,-64}},fillPattern=FillPattern.Solid,fillColor={255,0,0})}));
  ...
  package Components "Utility components needed for example"
    ...
    record DCMotorWatching
      "Signals observed from a DC motor as needed by DCMotorRequirements block"
       extends Requirements.Interfaces.PartialWatching;
    ...
    block DCMotorRequirements "Requirements for one DC Motor"
      ...
      Requirements.Verify.BooleanRequirement R_SpeedMax(text="Maximum speed is limited")
      ...
      Requirements.Verify.BooleanRequirement R_IaMax(text="Maximum current is limited")
    ...
    block Verify "Check requirements of OpenTanks and of Pumps"
      import Requirements.Examples.MotorsWithLosses.Components;

      extends Requirements.Interfaces.PartialVerify;
