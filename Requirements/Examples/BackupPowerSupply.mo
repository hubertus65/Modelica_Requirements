...
<p>This is a sliding WIndow issue</p><p>Using the given input signals <strong>MBSVoltage</strong>, <strong>On</strong>, and 
<strong>Available</strong> results in<br>
</p>

<table border=\"0\" cellspacing=\"0\" cellpadding=\"2\">
<tbody><tr><td width=\"50\"><br></td>
    <td><img src=\"modelica://Requirements/Resources/Images/Examples/MainPowerSupplyRequirements/MPS1.png\"></td>
   </tr>
</tbody></table>

<table border=\"0\" cellspacing=\"0\" cellpadding=\"2\">
<tbody><tr><td width=\"160\"><br></td>
...
<table border=\"0\" cellspacing=\"0\" cellpadding=\"2\">
<tbody><tr><td width=\"50\"><br></td>
    <td><img src=\"modelica://Requirements/Resources/Images/Examples/MainPowerSupplyRequirements/MPS2.png\"></td>
   </tr>
</tbody></table>
...
Requirements untested:
...
</html>"),Icon(graphics = {Ellipse(origin={74,62},extent={{-59.11230725440537,55.002050435341985},{60,-56}},fillPattern=FillPattern.Solid,fillColor={255,0,0})}));
  ...
  */
      ...
      // Modelica
      extends Requirements.Interfaces.PartialEnvironment;
      ...
      Modelica.Blocks.Interfaces.BooleanInput Available(start=false,fixed=true)
        "= true, if MPS is available" annotation (Placement(transformation(extent={{-240,
                ...
                -80}})));
      Requirements.Interfaces.EventOutput eLoss
        "Signals that the MPS has transited from available to unavailable" annotation (Placement(
            ...
            rotation=-90,
            origin={-120,-210})));
      Requirements.Interfaces.EventOutput eRestore
