...
<a href=\"Requirements.ChecksInFixedWindow_withFFT\">ChecksInFixedWindow_withFFT</a>.
</p>
...
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInFixedWindow_withFFT.WithinAbsoluteDomain1\">example</a>: 
</p>
...
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInFixedWindow_withFFT.WithinAbsoluteDomain2\">example</a>: 
</p>
...
<p>
This block is demonstrated with the following first
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInFixedWindow_withFFT.WithinRelativeDomain1\">example</a>: 
</p>
...
<p>
This block can be also used to compute several FFTs along a simulation as demonstrated with the following second
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInFixedWindow_withFFT.WithinRelativeDomain2\">example</a>: 
</p>
...
<p>
This block is demonstrated with the following first
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInFixedWindow_withFFT.MaxTotalHarmonicDistortion1\">example</a>: 
</p>
...
<p>
This block can be also used to compute several FFTs along a simulation as demonstrated with the following second
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInFixedWindow_withFFT.MaxTotalHamonicDistortion2\">example</a>: 
</p>
...
<tr><td valign=\"top\"> Nov. 29, 2015 </td>
  ...
  package Internal
    ...
    protected
        ...
        constant String resultDirectory = MIHOME + Requirements.Internal.getFirstName(instanceName);
        constant String filePrefix =      "FFT." + Requirements.Internal.removeFirstName(instanceName) + ".";
...
<tr><td valign=\"top\"> Nov. 29, 2015 </td>
  ...
  function checkDomain "Check whether FFT is in required domain"
      ...
      output Requirements.Types.Property property;
...
<a href=\"modelica://Requirements.ChecksInFixedWindow\">ChecksInFixedWindow</a>.<br>
...
<li> <a href=\"modelica://Requirements.Types.Property\">Property</a> output <b>y</b>:
...
<li> If you just would like to determine an FFT of a signal, set the simulation time to a large value
     ...
     <a href=\"modelica://Requirements.LogicalBlocks.FallingEdgeTerminate\">FallingEdgeTerminate</a>
     for this purpose.</li>
...
<p><blockquote>
<img src=\"modelica://Requirements/Resources/Images/Examples/Elementary/ChecksInFixedWindow_withFFT/IconAnimation.png\">
</blockquote></p>
