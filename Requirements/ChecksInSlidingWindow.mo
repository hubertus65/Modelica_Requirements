...
package ChecksInSlidingWindow
  ...
  block MinDuration
    ...
    import Requirements.Internal.SlidingWindow;
  ...
  protected
    ...
    Boolean first;
//    discrete Real count "count change of check";
...
<a href=\"modelica://Requirements.Types.Property\">Property</a>.
</p>
...
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MinDuration\">example</a> calling the block as:
</p>
...
// Changed Hubertus Tummescheit, to make work according to a) MLS and b) in Modelon Impact
//    when change(check) then
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MinAccumulatedDuration\">example</a> calling the block as:
</p>
...
</html>"),   Icon(graphics={Text(extent={{-180,45},{0,15}},fillColor={255,0,0},fillPattern=FillPattern.Solid,textString=" s"),Text(extent={{-180,92},{0,67}},lineColor={95,95,95},textString=">="),Line(points={{-192,70},{-184,70},{-184,88},{-174,88},{-174,70},{-164.01,70},{-164,87.9297},{-154,88},{-154,70},{-146,70}},color={255,0,0}),Ellipse(origin={215,95},extent={{-83,79},{83,-79}},fillPattern=FillPattern.Solid,fillColor={208,2,27})}));
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MinAccumulatedDuration2\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxDuration\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxAccumulatedDuration\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.BandDuration\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.BandAccumulatedDuration\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MinRising\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxRising\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.BandRising\">example</a> calling the block as:
</p>
...
<tr><td></td>
  ...
  protected
    ...
    SlidingWindow.Buffer buffer "Buffer for sliding window";
    SlidingWindow.Buffer preBuffer "Buffer for sliding window";
  ...
  equation
    ...
    when {checkChanging, time >= pre(t_next)} then
       preBuffer.T = pre(buffer.T);
       preBuffer.t0 = pre(buffer.t0);
       preBuffer.t = pre(buffer.t);
       preBuffer.b = pre(buffer.b);  
       preBuffer.first = pre(buffer.first);   
       preBuffer.last = pre(buffer.last);       
       preBuffer.nElem = pre(buffer.nElem);  
       buffer = if checkChanging then SlidingWindow.push(preBuffer,time) else
                   SlidingWindow.removeOldest(preBuffer, time);
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxFrequency\">example</a> calling the block as:
</p>
...
more precise as using the <a href=\"modelica://Requirements.ChecksInSlidingWindow.MeanRisingFrequency\">MeanRisingFrequency</a> block that takes only the
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxRisingFrequency\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxIncrease\">example</a> calling the block as:
</p>
...
<p>
The property is demonstrated with the following
<a href=\"modelica://Requirements.Examples.Elementary.ChecksInSlidingWindow.MaxPercentageIncrease\">example</a> calling the block as:
</p>
...
<a href=\"modelica://Requirements.ChecksInFixedWindow\">ChecksInFixedWindow</a>.
</p>
